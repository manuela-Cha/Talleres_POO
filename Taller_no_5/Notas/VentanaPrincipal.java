...
ActionListener {
    ...
    public void actionPerformed(ActionEvent evento) {
        ...
        if (evento.getSource() == calcular) { 
            ...
            notas.calcularPromedio(notas.listaNotas); 
            notas.calcularDesviación(notas.listaNotas);
            promedio.setText("Promedio = " + String.valueOf(String
            .format("%.2f", notas.calcularPromedio(notas.listaNotas))));
            double desv = notas.calcularDesviación(notas.listaNotas);
